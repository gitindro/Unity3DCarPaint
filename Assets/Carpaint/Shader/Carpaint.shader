...
Shader "Custom/Simple Lit Car Paint"
{
	...
	Properties
	{
		...
		[NoScaleOffset] _FlakeMap("Flake Normal Map", 2D) = "bump" {}
		_EnvMap("Environment Cube map", CUBE) = "" {}
		...
		SubShader
			{
				...
				#pragma vertex CarPaint_VertexSimple
				#pragma fragment CarPaint_FragmentSimple
				#define BUMP_SCALE_NOT_SUPPORTED 1

				#include "CarpaintInput.hlsl"
				#include "CarpainForwardPass.hlsl"
